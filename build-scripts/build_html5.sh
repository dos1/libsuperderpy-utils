...
emcmake cmake ../.. -DCMAKE_BUILD_TYPE=Release -DCMAKE_PREFIX_PATH=$EMSCRIPTEN/system/local -DALLEGRO5_LIBRARY=$EMSCRIPTEN/system/local/lib/allegro5.so -DCMAKE_INSTALL_PREFIX=output -DLIBSUPERDERPY_EMSCRIPTEN_MODE=asm.js -G Ninja
