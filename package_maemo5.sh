...
if [ -z "$NO_DOCKER" ]; then
  docker run --rm --privileged -v $(realpath ../..):/scratchbox/users/admin/src dosowisko/libsuperderpy-maemo5 "cd /src/utils/build-maemo5 && cmake ../.. -DCMAKE_BUILD_TYPE=RelWithDebInfo -DMAEMO5=ON && make -j3"
else
